...
function displayResults(dealerTotal, playerTotal, dealerCards, playerCards) {
  let result = detectResult(dealerTotal, playerTotal);

  displayHands(dealerTotal, playerTotal, dealerCards, playerCards);
...
function displayHands(dealerTotal, playerTotal, dealerCards, playerCards) {
  console.log('==============');
...
while (true) {
  ...
  if (busted(playerTotal)) {
    displayResults(dealerTotal, playerTotal, dealerCards, playerCards);
    if (playAgain()) {
      continue;
    } else {
      break;
